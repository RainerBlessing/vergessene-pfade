...
const Npc npcs[4] = {{1, 10, 7, 0, ROLE_KEEPER, "Aoi / Schreinhueterin"},
                     {1, 22, 9, 1, ROLE_RESIDENT, "Ren / Teehaendler"},
...
const Dialogue dialogues[7] = {
    ...
    {2,
     {"Stell deine Sandalen an die Tuer.\nEine Tasse Beifusstee gibt dir\n8 Lebenspunkte "
      "fuer die Reise.",
      "Du hast schon zwei Portionen dabei.\nTeile sie dir gut ein.\nMoege dein Weg "
      "friedlich sein."}},
    {2,
